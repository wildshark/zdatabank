            ...
            <ul class="nav ace-nav">
                ...
                <li class="purple dropdown-modal">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="badge badge-important"><?php echo get_total_notifications_by_day($conn);?></span>
                    </a>

                    <ul class="dropdown-menu-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
                        <li class="dropdown-header">
                            <i class="ace-icon fa fa-exclamation-triangle"></i>
                            <?php echo get_total_notifications_by_day($conn);?> Notifications
                        </li>
                ...
                <li class="green dropdown-modal">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        ...
                        <span class="badge badge-success"> <?php echo number_of_message($conn);?> </span>
                    </a>

                    <ul class="dropdown-menu-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
                        <li class="dropdown-header">
                            <i class="ace-icon fa fa-envelope-o"></i>
                            <?php echo number_of_message($conn);?> Messages
                        </li>
...
<script src="template/assets/js/spin.js"></script>

<script src="template/assets/js/elements.form.js"></script>
